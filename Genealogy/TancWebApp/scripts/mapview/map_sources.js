...
function loadSource(parishId, parishName, sourceId) {
    updateQryPar('pid', parishId);
    updateQryPar('pname', parishName);
...
function generateSources(serviceServiceMapDisplaySource, parishId, parishName, marriageCount, personCount) {
