...
GeneralMap.prototype = {
    ...
    init: function (selectorid, readyfunction) {
        ...
        this.setMapDetail();
        var params = {};
        this.ancUtils.twaGetJSON('/Parishs/GetParishsTypes', params, $.proxy(this.loadParishTypes, this));
    ...
    DrawMap: function () {
        ...
        if (this.zoomLevel < 12) {
            ...
            if (newLocation != "") {
                this.mapParishs.loadParish(newLocation, $.proxy(this.parishResults, this));
            }
        }
        //  trimMarkers();
    },
    parishResults: function (data) {
        ...
        $.each(data, function (source, sourceInfo) {
            ...
            if (this.displayedMarker.indexOf(sourceInfo.ParishName) < 0) {
                ...
                google.maps.event.addListener(marker, 'click', function () {
                    this.createInfoWindowContent(sourceInfo.ParishId, sourceInfo.ParishName, marker);
                }); //end click

                this.markersArray.push(marker);
                this.displayedMarker.push(sourceInfo.ParishName);
        ...
        if (parishId != '' &&
            ...
            this.createInfoWindowContent(parishId, parishName, parishMarker);
    ...
    createInfoWindowContent: function (parishId, parishName, marker) {
        ...
        var fresult = function (result) {
            ...
            $('#' + parishId + 'tra').live("click", $.proxy(function () { this.masterShowTab(1); return false; }, this));
            $('#' + parishId + 'reg').live("click", $.proxy(function () { this.masterShowTab(2); return false; }, this));
            $('#' + parishId + 'sou').live("click", $.proxy(function () { this.masterShowTab(3); return false; }, this));
            ...
            this.masterShowTab(1);
        };

        if (infowindowloaded == 0) {
            this.ancUtils.twaGetJSON('/Parishs/GetParishDetails', params, $.proxy(function () { fresult; }, this));
        }
    },
