...
//{
//    public class CombinedSearch// : EditorBaseModel<Guid>, ICombinedEventModel
//    {
//        //todo needs to be expanded to include references

//        public static int excepIdx=0;

//        private List<CombinedSearchResult> searchEventlist = new List<CombinedSearchResult>();
...
//        CombinedSearchOption filterEventSelection = new CombinedSearchOption();
...
//        public void SetFilterEventSelection(CombinedSearchOption param)
//        {
...
//            IEnumerable<CombinedSearchResult> results = null;
...
//            {
//                if (results != null)
//                    results = results.Union(marriagesBll.GetMarriages().Where(GetWhereM(SearchEventType.MarriageBride)).Select(GetSelectM(SearchEventType.MarriageBride)));
//                else
//                    results = marriagesBll.GetMarriages().Where(GetWhereM(SearchEventType.MarriageBride)).Select(GetSelectM(SearchEventType.MarriageBride));
//            }
...
//            {
//                if (results != null)
//                    results = results.Union(marriagesBll.GetMarriages().Where(GetWhereM(SearchEventType.MarriageGroom)).Select(GetSelectM(SearchEventType.MarriageGroom)));
//                else
//                    results = marriagesBll.GetMarriages().Where(GetWhereM(SearchEventType.MarriageGroom)).Select(GetSelectM(SearchEventType.MarriageGroom));
//            }
...
//                foreach (CombinedSearchResult sr in results)
//                {
...
//        public Func<Marriage, CombinedSearchResult> GetSelectM(SearchEventType _set)
//        {
//            Func<Marriage, CombinedSearchResult> personPred3 = new Func<Marriage, CombinedSearchResult>(cr => new CombinedSearchResult() { EntityObj = cr, EventTypeInt = (int)_set });

//            return personPred3;

//        }

//        public Func<Person, CombinedSearchResult> GetSelect(SearchEventType _set)
//        {
//            Func<Person, CombinedSearchResult> personPred3 = new Func<Person, CombinedSearchResult>(cr => new CombinedSearchResult() { EntityObj = cr, EventTypeInt = (int)_set });
...
//        public CombinedSearchOption FilterEventSelection
//        {
//            get 
//            {
...
//        public IList<CombinedSearchResult> SearchEvents
//        {
//            get 
//            {
